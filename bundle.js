...
var updateModal = exports.updateModal = function updateModal(modalStatus, type, id) {
  return {
    type: UPDATE_MODAL,
    payload: { isOpen: modalStatus, type: type, id: id }
  };
};
...
var updateNote = exports.updateNote = function updateNote(note, id) {
  return {
    type: UPDATE_NOTE,
    note: note,
    id: id
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(16),B=__webpack_require__(3),C=__webpack_require__(2),ba=__webpack_require__(17),da=__webpack_require__(18),ea=__webpack_require__(19),fa=__webpack_require__(20),ia=__webpack_require__(21),D=__webpack_require__(5);
...
var _root_reducer = __webpack_require__(60);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(13), __webpack_require__(54)(module)))
...
var _note_reducer = __webpack_require__(61);

var _note_reducer2 = _interopRequireDefault(_note_reducer);

var _modal_reducer = __webpack_require__(62);

var _modal_reducer2 = _interopRequireDefault(_modal_reducer);

var _content_reducer = __webpack_require__(63);
...
var RootReducer = (0, _redux.combineReducers)({
  note: _note_reducer2.default,
  modal: _modal_reducer2.default,
  content: _content_reducer2.default
});
...
var _note_actions = __webpack_require__(26);
...
var initialState = [{
  ...
  body: "This is where you can write your thoughts and anything else you want to share",
  color: "rgb(246, 150, 161)"
}, {
  title: "Things to do in SF",
  body: "Alcatraz Island \nGolden Gate Bridge \nFisherman's Wharf \nThe Exploratorium \nPlance of Fine Arts \nTwin Peaks \nCalifornia Academy of Sciences \nWalt Disney Family Museum",
...
var NoteReducer = function NoteReducer() {
  ...
  var newState = void 0;
  switch (action.type) {
    case _note_actions.ADD_NOTE:
      return [].concat(_toConsumableArray(state), [action.note]);
    case _note_actions.UPDATE_NOTE:
      newState = oldState.slice(0, action.id).concat([action.note]).concat(oldState.slice(action.id + 1));
      return newState;
    case _note_actions.DELETE_NOTE:
...
var _modal_actions = __webpack_require__(7);
...
var modalReducer = function modalReducer() {
  ...
  switch (action.type) {
    case _modal_actions.UPDATE_MODAL:
...
var _content_actions = __webpack_require__(14);
...
var _header_container = __webpack_require__(80);

var _header_container2 = _interopRequireDefault(_header_container);

var _note_index_container = __webpack_require__(82);

var _note_index_container2 = _interopRequireDefault(_note_index_container);

var _modal_container = __webpack_require__(85);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_note_index_container2.default, null),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    updateModal: function updateModal(isOpen, type, id) {
      return dispatch((0, _modal_actions.updateModal)(isOpen, type, id));
    }
  };
};
        ...
        _react2.default.createElement(
          "button",
          {
            onClick: function onClick() {
              return _this2.props.updateModal(true, "add", null);
            },
            className: "add-btn"
          },
          _react2.default.createElement(
...
var _note_index = __webpack_require__(83);

var _note_index2 = _interopRequireDefault(_note_index);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    updateTitle: function updateTitle(title) {
      return dispatch((0, _content_actions.updateTitle)(title));
    },
    updateBody: function updateBody(body) {
      return dispatch((0, _content_actions.updateBody)(body));
    },
    updateColor: function updateColor(color) {
      return dispatch((0, _content_actions.updateColor)(color));
    },
    updateModal: function updateModal(modalStatus, type, id) {
      return dispatch((0, _modal_actions.updateModal)(modalStatus, type, id));
    }
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_note_index2.default);
...
var _note_index_item = __webpack_require__(84);

var _note_index_item2 = _interopRequireDefault(_note_index_item);
...
var NoteIndex = function (_React$Component) {
  _inherits(NoteIndex, _React$Component);

  function NoteIndex(props) {
    _classCallCheck(this, NoteIndex);

    return _possibleConstructorReturn(this, (NoteIndex.__proto__ || Object.getPrototypeOf(NoteIndex)).call(this, props));
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.note.map(function (note, index) {
            return _react2.default.createElement(_note_index_item2.default, {
              key: index,
              id: index,
              note: note,
              updateModal: _this2.props.updateModal,
              updateTitle: _this2.props.updateTitle,
              updateBody: _this2.props.updateBody,
              updateColor: _this2.props.updateColor
            });
          })
        )
      );
...
var NoteIndexItem = function (_React$Component) {
  _inherits(NoteIndexItem, _React$Component);

  function NoteIndexItem(props) {
    _classCallCheck(this, NoteIndexItem);

    var _this = _possibleConstructorReturn(this, (NoteIndexItem.__proto__ || Object.getPrototypeOf(NoteIndexItem)).call(this, props));

    _this.state = {
      title: _this.props.note.title,
      body: _this.props.note.body,
  ...
  _createClass(NoteIndexItem, [{
    ...
    value: function render() {
      var _props$note = this.props.note,
          color = _props$note.color,
          title = _props$note.title,
          body = _props$note.body,
          id = _props$note.id;

      return _react2.default.createElement(
        "div",
        { className: "note" },
        _react2.default.createElement("div", { className: "note-color", style: { backgroundColor: color } }),
        _react2.default.createElement(
          "div",
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    addNote: function addNote(note) {
      return dispatch((0, _note_actions.addNote)(note));
    },
    updateModal: function updateModal(isOpen, type, id) {
      return dispatch((0, _modal_actions.updateModal)(isOpen, type, id));
    },
    updateNote: function updateNote(note, id) {
      return dispatch((0, _note_actions.updateNote)(note, id));
    },
    deleteNote: function deleteNote(id) {
      return dispatch((0, _note_actions.deleteNote)(id));
    }
  };
};
...
var Modal = function (_React$Component) {
  ...
  _createClass(Modal, [{
    ...
    key: "updateColor",
    value: function updateColor(color, e) {
      e.persist();
    ...
    value: function handleSubmit(e) {
      var _props = this.props,
          ...
          updateNote = _props.updateNote;

      e.preventDefault();
      if (this.props.modal.type === "add") {
        addNote(this.state);
      } else if (this.props.modal.type === "save") {
        var title = this.state.title === "" ? this.props.note[this.props.modal.id].title : this.state.title;
        var body = this.state.body === "" ? this.props.note[this.props.modal.id].body : this.state.body;
        var color = this.state.color === "rgb(246, 150, 161)" ? this.props.note[this.props.modal.id].color : this.state.color;
    ...
    value: function render() {
      ...
      var _props$modal2 = this.props.modal,
          id = _props$modal2.id,
          type = _props$modal2.type;
      var note = this.props.note;

      var title = note[id] ? note[id].title : this.state.title;
      var body = note[id] ? note[id].body : this.state.body;
      var color = note[id] ? note[id].color : this.state.color;
      if (color === "" && type === "add") {
        color = this.state.color;
      } else if (type === "save") {
        color = this.state.color;
      }
      var saveColor = this.state.addDisabled ? "#a2d8dc" : "#57b8c0";
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                "button",
                { className: "delete-btn", onClick: this.deleteNote },
                "Delete"
              )
            )
          ),
          !this.props.noBackdrop && _react2.default.createElement("div", {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement("button", {
                ...
                onClick: function onClick(e) {
                  return _this2.updateColor("rgb(246, 150, 161)", e);
                }
              }),
              _react2.default.createElement("button", {
                className: "btn-color btn-color-green",
                onClick: function onClick(e) {
                  return _this2.updateColor("rgb(168, 233, 199)", e);
                }
              }),
              _react2.default.createElement("button", {
                className: "btn-color btn-color-orange",
                onClick: function onClick(e) {
                  return _this2.updateColor("rgb(250, 212, 159)", e);
                }
              }),
              _react2.default.createElement("button", {
                className: "btn-color btn-color-blue",
                onClick: function onClick(e) {
                  return _this2.updateColor("rgb(159, 191, 249)", e);
                }
              })
            ),
            _react2.default.createElement(
